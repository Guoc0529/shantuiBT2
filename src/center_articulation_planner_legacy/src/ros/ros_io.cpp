...
namespace jhzx::center_articulation_planner
{
  ...
  {    
    ...
    pnh_.param<std::string>("drive_mode_topic", drive_mode_topic_, drive_mode_topic_);
  ...
  void RosIo::setupPublishers()
  {
    ...
    drive_mode_pub_ = nh_.advertise<std_msgs::UInt8>(drive_mode_topic_, 1);
  }
  ...
  void RosIo::publishDriveMode(std::uint8_t value)
  {
    std_msgs::UInt8 msg;
    msg.data = value;
